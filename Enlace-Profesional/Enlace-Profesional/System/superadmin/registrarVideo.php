							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									<div class="admin-section-title">
										<h2>Registrar un nuevo video</h2>									
									</div>
									
									<form class="post-form-wrapper" action="app/create-tutorial.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
                                                ...
                                                <div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="nameVideo" required type="text" id="id" class="form-control" placeholder="Ingrese el nombre">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="categoria" required class="form-control" data-live-search="true">
														<option disabled value="">Seleccionar</option>
														<option value = "graduados">Para graduados</option>
														<option value = "empleadores">Para empleadores</option>
