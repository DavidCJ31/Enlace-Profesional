...
<head>
	...
	<title>Intermediacion Laboral - Contacto</title>
			...
			<div class="section sm">
				...
				<div class="container">
					...
					<div class="row">
						...
						<img src="images/Contactos-Enlace-Profesional/Josue.jpeg" alt="JosueJU" width="300" height="400"> 
							<h3 style="text-align: left;">&nbsp;&nbsp;&nbsp;Josué Jimenez Ulate </h3>
					
							<ul class="address-list">
								<li>
										<h5>
										Académico responsable</h5>
								</li>
								<li>
										<h5>Correo Electrónico</h5><a href="mailto:enlaceprofesional@una.cr">enlaceprofesional@una.cr</a>
								</li>
								<li>
										<h5>Teléfono</h5><a href="tel:2277-3776">2277-3018</a>
								</li>
						...
						<div class="col-sm-6 col-md-6">
							<img src="images/Contactos-Enlace-Profesional/Franky.jpeg" alt="FrankyGC" width="250" height="350"> 
							<h3 style="text-align: left;">&nbsp;&nbsp;&nbsp;Franky González Conejo </h3>
							
							<ul class="address-list">
								<li>
										<h5>Académico responsable</h5>		
								</li>
								<li>
										<h5>Correo Electrónico</h5><a href="mailto:enlaceprofesional@una.cr">enlaceprofesional@una.cr</a>
								</li>
