                            ...
                            <div class="col-sm-12 col-md-2">
                                ...
                                <div class="resume-list-btn">
                                    ...
                                    <a data-toggle="modal" href="#edit<?php echo $row['id']; ?>"
                                        class="btn btn-primary btn-sm mb-5 mb-0-sm">Editar</a>
                                    <a href="app/drop-attachment.php?id=<?php echo $row['id']; ?>"
                                        onclick="return confirm('¿Está seguro que desea eliminar esta documentación?')"
                                        class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
                                    <div id="edit<?php echo $row['id']; ?>" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="app/update-attachment.php" method="POST"
								    ...
								    <input class="form-control" value="<?php //echo "$att_issuer"; ?>" placeholder="Ingrese editor" type="text" name="issuer" required> 
                                                            ...
                                                            <div class="col-sm-12 col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label style="text-align: left">Seleccionar Adjunto
                                                                        <i>(Dejar en blanco si no desea
                                                                            actualizar)</i></label>
                                                ...
                                                <div class="modal-footer text-center">
                                                    ...
                                                    <button type="button" data-dismiss="modal"
                                                        class="btn btn-primary btn-inverse">Cerrar</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
                ...
                <div id="QualifModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="app/add-attachment.php" method="POST" autocomplete="off"
