                    ...
                    <div class="GridLex-col-3_sm-4_xs-12">
                        ...
                        <div class="admin-sidebar">
                            ...
                            <ul class="admin-user-menu clearfix">
                                ...
                                <li>
                                    <a href="academic-certifications.php"><i class="fa fa-trophy"></i>Certificaciones
                                        académicas</a>
                                </li>
                                <!-- <li>
                                ...
                                <li>
                                    <a href="attachments.php"><i class="fa fa-folder-open"></i> Otros Documentos
                                        Adjuntos</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="configuration.php"><i class="fa fa-cogs"></i>Configuración de la
                                        cuenta</a>
                                </li>
                                <li>
                                    <a href="vistaPerfil.php?empid=<?php echo $myid; ?>"><i class="fa fa-users"></i>
                                        Vista de la empresa del perfil</a>
                                </li>
                                <li>
